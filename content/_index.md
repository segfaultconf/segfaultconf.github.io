---
events:
  title: Interdyscyplinarna przestrzeń dla twórców technologii i pasjonatów programowania
  lead: |      
    Segfault realizuje wydarzenia technologiczne online i offline, szkolenia i warsztaty oraz webinary i podcasty dedykowane doświadczonym programistom, inżynierom, architektom i tech liderom.

    Wspólnie dyskutujemy, podważamy, kwestionujemy, testujemy i sprawdzamy co znaczy "Deliver • Quality • Software". 
company:
  lead: |
    Segfault to firma, której członkowie zawodowo związani są z wytwarzaniem oprogramowania na wielu jego poziomach - zarówno jako programiści, architekci, jak i konsultanci.
